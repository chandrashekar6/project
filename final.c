...
void carcker(int x1,int y1)
{
for(int r=0;r<40;r=r+2)
{
for(int angle=0;angle<=90;angle=angle+15)
{

mirror((r*cos(angle))-x1,(r*cos(angle))-y1);
}
...
/*
void dog_right(int r, int x , int y)
{
...
//legs
line(x+4r, y, x+3r, y+4r);
line(x+4r, y, x+5r,y+4r );
